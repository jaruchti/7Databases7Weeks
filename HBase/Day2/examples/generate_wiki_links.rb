# Book example of parsing wikipedia data for article links and storing
# the data in the 'links' table created in Day #2.  The links are bi-directional.
...
while ( result = scanner.next() )
  ...
  count += 1
  puts "#{count} pages processsed (#{title})" if count % 500 == 0
end
